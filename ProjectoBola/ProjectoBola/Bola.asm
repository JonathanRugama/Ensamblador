...
TgoJA	byte		"Game Over - Gana Jugador Andres",0
TgoJB	byte		"Game Over - Gana Jugador Juan",0
...
Inicio: call		GetMaxXY	;Toma el Tamaño Actual de la Ventana de Consola.
		...
		call        Wconta      ;Escribe contadores para jugadores
...
GameO1: call		CBall		;Borro la Bola. (Pierde Raqueta A).
		mov			dh,Raf		;Escribe Raqueta A.
		mov			dl,Rac
		call		WRaq
...
;*************************************************************************************************
; PROCEDIMIENTO INICIAR - Inicializa Variables.
;*************************************************************************************************
...
Iniciar	PROC
		call		CBall
		mov			Col,60		;Inicializa Columna de Bola.
...
;*************************************************************************************************
; PROCEDIMIENTO WJUGA - Escribe Contadores para Jugadores A y B
;*************************************************************************************************
